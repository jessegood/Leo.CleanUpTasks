namespace Leo.CleanUpTasks
{
    partial class CleanUpSourceSettingsControl
    {
        ...
        {
            this.segmentLockerControl = new Leo.CleanUpTasks.SegmentLockerControl();
            this.conversionsSettingsControl = new Leo.CleanUpTasks.ConversionsSettingsControl();
            this.tagsSettingsControl = new Leo.CleanUpTasks.TagsSettingsControl();
            this.SuspendLayout();
            // 
